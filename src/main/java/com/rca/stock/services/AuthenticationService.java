...
public class AuthenticationService {
    ...
    public void register(RegisterRequest request) throws MessagingException {
        createUserWithRole(request, Role.USER);
    }

    public void registerManager(RegisterRequest request) throws MessagingException {
        createUserWithRole(request, Role.MANAGER);
    }

    public void registerAdmin(RegisterRequest request) throws MessagingException {
        createUserWithRole(request, Role.ADMIN);
    }

    private void createUserWithRole(RegisterRequest request, Role role) throws MessagingException {
